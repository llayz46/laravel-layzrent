<div class="mx-auto max-w-full px-2 sm:px-4 lg:px-8">
    <div class="border-b border-gray-200 dark:border-gray-700 pb-2 mt-8 flex justify-between items-center">
        <div>
            <h2 class="text-title font-semibold text-xl">Your properties</h2>
            <p class="text-body">Browse all your properties or create a new one</p>
        </div>
        <x-button tag="a" href="{{ route('properties.create') }}" style="secondary">Add a property</x-button>
    </div>
    ...
    <div x-data="{ modalOpen: false }"
        ...
        <template x-teleport="body">
            <div x-show="modalOpen" class="fixed top-20 left-0 z-[99] flex items-center justify-center w-screen h-screen" x-cloak>
                <div x-show="modalOpen"
                     ...
                     @click="modalOpen=false" class="absolute inset-0 w-full h-full bg-white backdrop-blur-sm bg-opacity-50"></div>
                <div x-show="modalOpen"
                     x-trap.inert.scroll="modalOpen"
                     x-transition:enter="ease-out duration-300"
                    ...
                    <div class="flex items-center justify-between pb-3">
                        <h3 class="text-lg font-semibold">Create a new property</h3>
